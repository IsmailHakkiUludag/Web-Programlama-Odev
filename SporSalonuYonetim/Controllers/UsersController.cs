...
namespace SporSalonuYonetim.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(UserManager<Kullanici> userManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        private async Task<List<string>> _getUserRoles(Kullanici user)
        {
